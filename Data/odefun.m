function dxdt = odefun(t,x)
  ...
  dxdt(2)  = c(2)*dxdt(1)+c(3)*x(2)+c(4)*x(2);  %inflation
  dxdt(3)  = c(5)*x(2)+c(6)*x(6)+c(7)*x(8)+c(49)*x(13); %P/E ratio
  dxdt(4)  = c(8)*dxdt(1)+c(9)*x(2)+c(10)*x(4)+c(11)*x(4)*x(8); %Fed funds rate
  dxdt(5)  = c(12)*x(8)+c(13)*x(10)+c(14)*x(4)+c(15)*x(12);%Nasdaq-100
  dxdt(6)  = c(16)*x(6)+c(17)+c(18)*x(12)+c(19)*x(11); %Apples Net Income
  ...
  dxdt(11) = c(37)*x(11)+c(38)+c(39)*x(11); %iPhone Revenue
